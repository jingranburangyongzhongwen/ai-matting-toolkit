...
def bind_tab2_events(demo, c, model_concurrency_limit):
    ...
    c["engine_mode"].change(
        ...
        outputs=[c["result_img"], c["result_view_btn"], c["result_download_btn"],
                 ...
                 c["auto_masks_state"], c["image_id_state"],
                 c["auto_select_mode"], c["text_caption"], c["cutout_status"],
                 c["selected_auto_mask"], c["selected_auto_indices"]],
        queue=False, show_progress="hidden",
    )
    c["engine_mode"].change(
    ...
    c["canvas_files"].upload(
        ...
        outputs=[c["canvas_files"], c["canvas_img"], c["canvas_view_btn"],
                 ...
                 c["auto_masks_state"], c["image_id_state"],
                 c["auto_select_mode"], c["cutout_status"], c["selected_auto_mask"],
    ...
    c["canvas_img"].select(
        ...
        inputs=[c["canvas_img"], c["click_mode"], c["engine_mode"],
                c["points_state"], c["labels_state"], c["box_state"],
                c["auto_masks_state"], c["auto_select_mode"],
                c["image_id_state"], c["selected_auto_indices"]],
        outputs=[c["result_img"], c["result_view_btn"], c["result_download_btn"],
                 c["points_state"], c["labels_state"], c["box_state"],
                 c["auto_select_mode"], c["cutout_status"], c["selected_auto_mask"],
                 c["selected_auto_indices"]],
    ...
    generate_start.then(
        ...
        inputs=[c["canvas_img"], c["engine_mode"], c["tab2_output_mode"],
                ...
                c["image_id_state"], c["selected_auto_mask"],
                c["selected_auto_indices"]],
        outputs=[c["result_img"], c["result_view_btn"], c["result_download_btn"],
    ...
    c["undo_btn"].click(
        ...
        inputs=[c["canvas_img"], c["points_state"], c["labels_state"], c["box_state"],
                c["auto_masks_state"], c["auto_select_mode"], c["engine_mode"],
                c["image_id_state"], c["selected_auto_indices"]],
        outputs=[c["result_img"], c["result_view_btn"], c["result_download_btn"],
                 c["points_state"], c["labels_state"], c["box_state"],
                 c["auto_select_mode"], c["cutout_status"], c["selected_auto_mask"],
